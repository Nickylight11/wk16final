...
const RecordBPList = () => {
  ...
  const handleDeleteRecord = async (id) => {
    try {
      ...
      await axios.delete(
        `https://65b1572dd16d31d11bdeba79.mockapi.io/BenchPressRecords/${id}`
      );
  ...
  const handleUpdateRecord = async () => {
    try {
      ...
      await axios.put(
        `https://65b1572dd16d31d11bdeba79.mockapi.io/BenchPressRecords/${editRecordId}`,
        updatedRecord
      );
  ...
  return (
    <div className="RecordBPListContainer">
      <h2 className="mt-3 mb-4">Bench Press Records</h2>
      {/* Edit form display */}
      {showEditForm && (
