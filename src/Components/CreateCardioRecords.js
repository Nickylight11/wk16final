...
const CreateCardioRecord = () => {
  ...
  const handleCreateCardioRecord = async () => {
    try {
      // Validate input
      if (!exerciseType || !setDistance || !date) {
      ...
      const newRecord = {
        exerciseType,
        setDistance: parseFloat(setDistance),
        date,
      };
  ...
  return (
    <div>
      ...
      <form>
        ...
        />
        <button type="button" onClick={handleCreateCardioRecord}>
          Create Record
        </button>
      </form>
...
export default CreateCardioRecord;
